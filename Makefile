...
all: .envsetup src gnulinux-i686 gnulinux-x86_64 windows-i386 macosx-i386
...
gnulinux-i686: dist/fteproxy-$(FTEPROXY_VER)-linux-i686.tar.gz
...
dist/fteproxy-$(FTEPROXY_VER)-linux-i686.tar.gz:
	@cd $(BUILD_DIR_ABSPATH)/gnulinux-i686; \
	vagrant up; \
